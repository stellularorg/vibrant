...
export function create_editor(
    ...
    (globalThis as any).FileEditor = {
        ...
        Format: async () => {
            try {
                ...
                (globalThis as any).FileEditor.Update(formatted);
            } catch (err) {
                alert(err);
            }
        },
    ...
    if (preview_button && preview_pane) {
        ...
        preview_button.addEventListener("click", () => {
            ...
            // create blob
            const blob = new Blob([(globalThis as any).FileEditor.Content], {
                type: "text/html",
            });
            ...
            preview_pane.addEventListener("load", () => {
                ...
                (globalThis as any).update_document_content = () => {
                    // update content
                    (globalThis as any).FileEditor.Update(
